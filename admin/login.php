...
// Admin Panel
 ...
 if( isset($_POST['login']) ) {   
  ...
  if (!$error) {   
   ...
   $res=mysqli_query($con,"SELECT adminId, adminName, adminPass FROM admin WHERE adminEmail='$email'");
			...
			<div id="login-form">
				...
				<form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">					
					<div class="col-md-12">							
						...
						?>						
						<div class="form-group">
						<small style="#888888 !important;margin-bottom:5px !important" id="emailHelp" class="form-text text-muted">Login as Admin</small>
						...
						<div class="form-group">
							...
							<a href="../student/login.php"> Parents</a>
						</div>					
					</div>			   
				</form>
			</div>
